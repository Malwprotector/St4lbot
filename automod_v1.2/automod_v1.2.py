...
#BASE      
        ...
        if message.content.startswith('/info'):
            ...
            await message.channel.send(' {0.author.mention} **Autobotmod, made by @user#0000, 1.2 version |** https://github.com/malwprotector \n **source code:** https://bit.ly/3IopiTp \n *use / prefix to send command.*'.format(message))

        if message.content.startswith('/update_info_fr'):
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** used the BASE plugin. \n server: {0.guild.name} **".format(message))
            await message.channel.purge(limit=1)
            await message.channel.send("** Automod a été mis à jour vers sa version 1.2! ** \n **ajouts:** Modifications avancées du code source, ajout de plusieurs commandes d'administration et du plugin AUTORESPOND \n **Langue actuelle:** French 🇧🇪​ - 🇨🇵​ \n **Informations sur le développeur:** @Lushketchup8624#7559  - https://github.com/malwprotector \n **Code source:** https://bit.ly/3IopiTp \n *Contactez le développeur pour les informations complémentaires.*".format(message))    
...
#AUTOMOD
        ...
        if message.content.startswith('/banned_word/') or message.content.startswith('Con'):
            await message.channel.purge(limit=1)
            channel = client.get_channel(/logs/)
        ...
        if message.content.startswith('/banned_word/') or message.content.startswith('Nique') or message.content.startswith('niquer') or message.content.startswith('Niquer'):
            await message.channel.purge(limit=1)
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** received a warning for use of vocabulary. \n server: {0.guild.name} **".format(message))
            await message.channel.send('⚠️​ **Attention** {0.author.mention} **, tu utilises du vocabulaire inapproprié! **'.format(message), delete_after=2,)

        if message.content.startswith('/banned_word/') or message.content.startswith('enculé') or message.content.startswith('Enculer') or message.content.startswith('Enculé'):
            await message.channel.purge(limit=1)
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** received a warning for use of vocabulary. \n server: {0.guild.name} **".format(message))
            await message.channel.send('⚠️​ **Attention** {0.author.mention} **, tu utilises du vocabulaire inapproprié! **'.format(message), delete_after=2,)

        if message.content.startswith('/banned_word/') or message.content.startswith('ptn') or message.content.startswith('Putain') or message.content.startswith('Ptn'):
            await message.channel.purge(limit=1)
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** received a warning for use of vocabulary. \n server: {0.guild.name} **".format(message))
            await message.channel.send('⚠️​ **Attention** {0.author.mention} **, tu utilises du vocabulaire inapproprié! **'.format(message), delete_after=2,)

        if message.content.startswith('/banned_word/') or message.content.startswith('Connard'):
            await message.channel.purge(limit=1)
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** received a warning for use of vocabulary. \n server: {0.guild.name} **".format(message))
            await message.channel.send('⚠️​ **Attention** {0.author.mention} **, tu utilises du vocabulaire inapproprié! **'.format(message), delete_after=2,)

        if message.content.startswith('/banned_word/') or message.content.startswith('Ntm'):
            await message.channel.purge(limit=1)
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** received a warning for use of vocabulary. \n server: {0.guild.name} **".format(message))
            await message.channel.send('⚠️​ **Attention** {0.author.mention} **, tu utilises du vocabulaire inapproprié! **'.format(message), delete_after=2,)

        if message.content.startswith('/banned_word/') or message.content.startswith('Merde'):
            await message.channel.purge(limit=1)
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** received a warning for use of vocabulary. \n server: {0.guild.name} **".format(message))
            await message.channel.send('⚠️​ **Attention** {0.author.mention} **, tu utilises du vocabulaire inapproprié! **'.format(message), delete_after=2,)

        if message.content.startswith('/banned_word/') or message.content.startswith('Tg'):
            await message.channel.purge(limit=1)
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** received a warning for use of vocabulary. \n server: {0.guild.name} **".format(message))
            await message.channel.send('⚠️​ **Attention** {0.author.mention} **, tu utilises du vocabulaire inapproprié! **'.format(message), delete_after=2,)

        if message.content.startswith('/banned_word/') or message.content.startswith('Ftg'):
            await message.channel.purge(limit=1)
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** received a warning for use of vocabulary. \n server: {0.guild.name} **".format(message))
            await message.channel.send('⚠️​ **Attention** {0.author.mention} **, tu utilises du vocabulaire inapproprié! **'.format(message), delete_after=2,)
...
#AUTORESPOND_plugin
        ...
        if message.content.startswith('ca va et toi') or message.content.startswith('ça va et toi') or message.content.startswith('Ca va et toi') or message.content.startswith('Ça va et toi') or message.content.startswith('bien') or message.content.startswith('Bien') or message.content.startswith('ouais') or message.content.startswith('Ouais') or message.content.startswith('oui') or message.content.startswith('Oui'):
            channel = client.get_channel(/logs/)
            await channel.send(" {0.author.mention} ** used the AUTORESPOND plugin. \n server: {0.guild.name} **".format(message))
